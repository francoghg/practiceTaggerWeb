...
module.exports = __webpack_require__(/*! C:\Users\Franco\Desktop\GRAIPH\Memoria\Tagger\practiceTagger\src\main.ts */"zUnb");
...
const environment = {
    ...
    scriptUrl: "http://127.0.0.1:5000/process"
};
/*
...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | tagger-tagger-module */ "tagger-tagger-module").then(__webpack_require__.bind(null, /*! ./tagger/tagger.module */ "Dzuf")).then(m => m.TaggerModule)
    }
];
